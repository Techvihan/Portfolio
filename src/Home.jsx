        ...
        <>
            <div className="flex flex-col mx-20 md:mx-24 sm:mx-20 absolute mt-20 sm:flex-row space-y-4 sm:space-x-4">
                ...
                <div className="flex flex-col space-y-2">
                    ...
                    <button className="bg-yellow-400 border-2 border-yellow-700 text-white font-bold p-2 rounded-md w-24 hover:bg-yellow-500"><a target="_blank" href="https://drive.google.com/file/d/1znqDuUMgWJAslDwivfJWznXcAny37Feu/view">Resume</a></button>
