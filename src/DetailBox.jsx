...
function DetailBox(props) {
  return (
    <div className="border-2 sm:w-96 w-full flex justify-start hover:transition hover:animate-pulse ease-in-out delay-150  hover:-translate-y-1 cursor-pointer 
